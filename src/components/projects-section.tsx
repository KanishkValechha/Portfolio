        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {projects.map((p, i) => (
            <motion.a
              ...
              className="group border-border flex flex-col overflow-hidden rounded-xl border no-underline transition-all duration-300 hover:-translate-y-1 hover:border-zinc-700"
            >
              <div className="bg-card h-48 w-full overflow-hidden">
                <img
                  src={p.image}
                  alt={p.title}
                  loading="lazy"
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <p className="text-muted-foreground mb-3.5 flex-1 text-sm leading-relaxed">
                  {p.description}
                </p>
                ...
                {p.github && (
                  <span
                    className="text-muted-foreground/60 inline-block cursor-pointer font-mono text-xs transition-colors hover:text-blue-500"
                    onClick={(e) => {
                      e.preventDefault()
                      e.stopPropagation()
